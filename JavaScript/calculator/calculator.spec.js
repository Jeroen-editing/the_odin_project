...
describe('add', function() {
	...
	it('adds multiplee numbers', function() {
		expect(calculator.add(2,4,6,8,10,12)).toEqual(42);
	});
});
...
describe('subtract', function() {
	...
	it('subtracts multiple numbers', function() {
		expect(calculator.subtract(100,4,20)).toEqual(76);
	});
});
...
describe('multiply', function() {
	...
	it('handles empty arrays', function() {
		expect(calculator.multiply([])).toEqual(0);
	});
...
describe('power', function() {
	...
	it('raises one number to the power of another number', function() {
		expect(calculator.power(2,8)).toEqual(256); // 4 to third power is 64
	});
	it('raises one number to the power of another number', function() {
		expect(calculator.power(-6,9)).toEqual(-10077696); // 4 to third power is 64
	});
});
