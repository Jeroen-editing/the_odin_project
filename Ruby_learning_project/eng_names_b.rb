def englishNumber number
  ...
  if write > 0
    ...
    # Remember that "write" is (at the moment) the number of hundreds we have to write out.
    # After we add "hundreds" to "numString", we add the string ' hundred' after it.
    # So, for example, if we originally called englishNumber with 1999 (so "number" = 1999),
    # then at this point "write" would be 19, and "left" would be 99.
    # The laziest thing to do at this point is to have englishNumber write out the 'nineteen' for us,
    # then we write out ' hundred', and then the rest of englishNumber writes out 'ninety-nine'.
